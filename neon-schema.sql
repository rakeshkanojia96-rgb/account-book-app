...
CREATE TABLE IF NOT EXISTS sales (
    ...
    unit_price NUMERIC DEFAULT 0, -- Unit Cost (purchase price per unit, excl. purchase GST)
    purchase_gst_percentage NUMERIC DEFAULT 0, -- Purchase GST % on Unit Cost
    amount NUMERIC DEFAULT 0, -- Base amount (Amount Received net of sale GST)
    gst_amount NUMERIC DEFAULT 0, -- Sale GST extracted from Amount Received
    total_amount NUMERIC DEFAULT 0, -- Equals Amount Received (GST-inclusive)
    payment_method TEXT,
    notes TEXT,
    gst_percentage NUMERIC DEFAULT 18, -- Sale GST % on Amount Received
